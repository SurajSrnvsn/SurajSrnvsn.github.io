...
const Projects = () => {
  ...
  return (
    <section className="section">
      ...
      <p>Click on a project to see details and tech stack. Video walkthroughs coming soon.</p>
              ...
              <div style={detailsStyle}>
                ...
                {project.video ? (
                  ...
                  <div style={videoPlaceholderStyle}>
                    <p><strong>Video Demo Coming Soon</strong></p>
                    <p style={{ fontSize: '0.9rem', marginTop: '5px' }}>
                      A walkthrough of <span style={techHighlightStyle}>{project.title}</span> will be added here.
                    </p>
                    <p style={{ fontSize: '0.8rem', marginTop: '10px', fontStyle: 'italic' }}>
